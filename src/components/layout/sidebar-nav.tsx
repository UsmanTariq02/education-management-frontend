...
const navItems = [
  ...
  { href: "/batch-subject-assignments", label: "Assignments", icon: Waypoints, permissions: ["batch-subject-assignments.read"], section: "academics", module: "ACADEMICS" as OrganizationModule },
  ...
  { href: "/report-cards", label: "Report Cards", icon: ClipboardCheck, permissions: ["exam-results.read"], section: "academics", module: "ACADEMICS" as OrganizationModule },
