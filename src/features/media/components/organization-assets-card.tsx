    ...
    <Card>
      ...
      <CardContent className="space-y-5">
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <select className="h-10 rounded-2xl border border-border/70 bg-background px-3 text-sm shadow-sm" value={type} onChange={(event) => setType(event.target.value as OrganizationAssetType)}>
            {assetTypes.map((item) => (
